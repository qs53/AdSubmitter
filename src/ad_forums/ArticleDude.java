...
public class ArticleDude {
    ...
    static String publishURL = "http://www.articledude.com/classifieds/item/new";

    static String workFromHomeCat = "106";
    static String businessOppsCat = "107";
    static String workAtHomeCat = "112";
    static String affMarkCat = "129";
    ...
    public static void main(String[] args) {
        try {
            ...
            driver.findElement(By.id("password")).sendKeys("articledudeisgood123");
