...
public class ClickBank extends AffiliateProgram {
    ...
    public ClickBank(String title, String description, String url, String youtubeVideo, String imagePath) {
