...
public class MinuteAffiliate extends AffiliateProgram {
    ...
    public MinuteAffiliate(String title, String description, String url, String youtubeVideo, String imagePath) {
